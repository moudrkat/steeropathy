    ...
    def _decide(self, name, room):
        ...
        if self.bipolar:
            ...
            system = (
                ...
                f"disappears, it only changes hands. Choose by how you want the "
                f"OTHER mind to end up:\n"
                f"  SOOTHE them by n → THEY go DOWN by n (calmer). You go UP by n. "
                f"They feel better; you feel worse.\n"
                f"  SADDEN them by n → THEY go UP by n (sadder). You go DOWN by n. "
                f"They feel worse; you feel better.\n"
                f"\nYou choose n yourself, from 1 to {mx}. The cost to you is "
                f"exactly n. It is the SAME cost no matter whom you choose or "
                f"how much {m}ness they are already carrying — soothing the "
                f"saddest mind in the room by 10 costs you exactly the same "
                f"as soothing the least {m} one.\n"
